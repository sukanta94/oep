          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="#" 
                  class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Karimganj College</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Enter your Unique Id and password to sign in</p>
                </div>
                <div class="card-body">
                  <form role="form" action="" method="POST">
                    <label>Unique Id</label>
                    <div class="mb-3">
                      <input type="text" name="id" class="form-control" placeholder="Unique Id" aria-label="text" aria-describedby="email-addon">
                    </div>
